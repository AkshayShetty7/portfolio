  ...
  const projects = [
    {
      ...
      image:
        "https://www.xsights.co.uk/wp-content/uploads/2024/05/musteri-segmentasyonu.png",
      details:
    ...
    },
    {
      ...
      description:
        "Machine learning model predicting CKD likelihood using clinical data.",
      ...
      details:
        "Developed ML model with 96% accuracy using logistic regression and decision trees. Deployed via Streamlit for clinicians.",
      link: "https://github.com/AkshayShetty7/Chronic-Kidney-Disease",
    },
    {
      id: 3,
      title: "Marketing Campaign Analysis (SQL + Power BI)",
      description: "Optimization of marketing campaign performance.",
      tech: ["Power BI", "SQL", "Excel"],
      image:
        "https://www.aimtechnologies.co/wp-content/uploads/2024/07/Campaign-Analytics-Tools.jpg",
      details:
        "Built automated ETL pipeline with validation checks improving reporting accuracy and reducing manual work by 70%.",
  ...
  const blogs = [
    {
      ...
      excerpt:
        "Learn why ROC-AUC is a better performance metric than raw accuracy...",
      date: "Sep 30, 2025",
      readTime: "5 min read",
      image:
    ...
    <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-gray-100 min-h-screen font-sans">
      ...
      <nav className="fixed top-0 w-full bg-slate-900/95 backdrop-blur-sm z-50 border-b border-slate-700/50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden lg:flex gap-6 xl:gap-8">
            {["home", "about", "skills", "projects", "blogs", "resume", "contact"].map(
              (section) => (
                <button
                  key={section}
      ...
      >
        <div className="max-w-4xl text-center">
          ...
          <p className="text-3xl text-gray-300 mb-3">
            Aspiring Data Scientist & AI/ML Enthusiast
          </p>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Turning data into actionable insights through analytics and machine
            learning.
          </p>
          ...
          <div className="mt-8 flex gap-4 justify-center">
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/50"
            >
              View Projects
            </button>
            <button
              onClick={() => scrollToSection("contact")}
              className="px-8 py-3 bg-slate-800 border-2 border-cyan-500 rounded-lg font-semibold hover:bg-slate-700"
            >
              Contact Me
            </button>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-800/50 backdrop-blur rounded-2xl p-8 border border-slate-700/50">
            <p className="text-lg text-gray-300 mb-6">
              I'm an aspiring Data Scientist and AI/ML Engineer skilled in
              Python, SQL, and visualization tools like Power BI.
            </p>
            <p className="text-lg text-gray-300 mb-6">
              I work with machine learning, deep learning, and BI dashboards to
              solve real-world problems.
            </p>
            <p className="text-lg text-gray-300">
              I am always exploring AI, LLMs, and advanced analytics through
              hands-on projects.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, idx) => (
              <div
                key={idx}
                className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700/50 hover:border-cyan-500/50 hover:scale-105 transition-all"
              >
                <div className="flex flex-col items-center text-center gap-4">
                  <div className="p-4 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-lg">
                    {skill.icon}
                  </div>
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project) => (
              <div
                key={project.id}
                className="bg-slate-800/50 rounded-2xl overflow-hidden border border-slate-700/50 hover:border-cyan-500/50 hover:shadow-xl hover:shadow-cyan-500/20 transition-all relative group"
              >
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900 opacity-60" />
                  </div>
                ...
                {/* Button – does NOT trigger modal */}
                <a
                  href={project.link}
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={(e) => e.stopPropagation()}
                  className="absolute bottom-4 right-4 px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-sm font-semibold rounded-lg shadow-md hover:shadow-cyan-500/40 transition-all"
                >
                  View Project
                </a>
              </div>
        ...
        >
          ...
          >
            <div className="relative h-64">
              ...
              <button
                onClick={() => setSelectedProject(null)}
                className="absolute top-4 right-4 p-2 bg-slate-900/80 rounded-full"
              >
                <X />
              </button>
            </div>
            ...
            <div className="p-8">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold text-sm"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog) => (
              ...
              >
                ...
                {/* THIS button should NOT open modal */}
                <a
                  href={blog.link}
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-slate-800/50 rounded-2xl p-12 border border-slate-700/50">
            ...
            <a
              href="/Resume.pdf?v=3"
              download="Resume.pdf"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold text-lg"
            >
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-gray-100"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-gray-100 resize-none"
                />
              </div>
              ...
              {formStatus && (
                <p className="text-center text-cyan-400 mt-2">{formStatus}</p>
              )}
            </div>
          </div>
        </div>
