        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-800/50 backdrop-blur rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-500/50 transition-all">
            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
              I'm a passionate data analyst and data scientist with expertise in extracting meaningful insights from complex datasets. With strong proficiency in SQL, Python, and data visualization tools like Power BI, I specialize in turning raw data into strategic business decisions that drive growth and efficiency.
            </p>
            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
